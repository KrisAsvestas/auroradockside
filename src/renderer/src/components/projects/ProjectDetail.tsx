...
const heroFieldClass =
  'w-full rounded-lg border border-white/10 bg-white/5 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm transition hover:border-cyan-300/40 hover:bg-white/10 focus:border-cyan-400 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50'
...
export function ProjectDetail({ name }: { name: string }): React.JSX.Element {
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-5 p-6">
      <header className="overflow-hidden rounded-2xl border border-white/10 bg-neutral-950 text-white shadow-[0_24px_70px_rgba(0,0,0,0.28)]">
        <div className="relative p-5">
          ...
          <div className="relative flex flex-wrap items-start justify-between gap-4">
            <div className="min-w-0">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1 text-xs font-semibold text-cyan-100 shadow-sm">
                <Gauge size={13} />
            ...
            <div className="flex flex-wrap justify-end gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-white/10 bg-white/10 px-3 py-1.5 text-sm font-medium text-white shadow-sm transition hover:bg-white/[0.15] disabled:cursor-not-allowed disabled:opacity-40"
              >
                <Square size={14} /> Stop
              </button>
              <button
              ...
              {applicationManifest?.project?.adminPath && isRunning && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 rounded-md border border-white/10 bg-white/10 px-3 py-1.5 text-sm font-medium text-white shadow-sm transition hover:bg-white/[0.15]"
                >
                  <KeyRound size={14} /> Application Admin
                </a>
              )}
              {applicationManifest?.project?.adminPath && isRunning && project.wordpress_network_admin_url && (
                <a href={project.wordpress_network_admin_url} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 rounded-md border border-white/10 bg-white/10 px-3 py-1.5 text-sm font-medium text-white shadow-sm transition hover:bg-white/[0.15]">
          ...
          <div className="relative mt-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-xl border border-white/10 bg-white/[0.08] p-4 shadow-sm backdrop-blur">
              ...
              <div className="mb-3 flex items-center justify-between">
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    project.xdebug_enabled ? 'bg-cyan-500' : 'bg-white/15'
                  )}
                >
                  <span
                    className={clsx(
